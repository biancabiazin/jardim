...
<body>
    ...
    <div class="formulario-inserir">
        <form class="formulario" method="POST" action="../../php/Paginas/Funcionarios/FuncionarioDelete.php">
            <b> ID </b> <br> 
            <input class="input" type="number" name="id_funcionario" placeholder="Insira o ID do Funcionário que quer Deletar" value="<?php echo $idFuncionario ?>"><br>
