...
<body>
    ...
    <div class="formulario-inserir">
        <form class="formulario" method="POST" action="../../php/Paginas/Clientes/ClienteUpdate.php">
            <b> ID </b> <br> 
            <input class="input" type="number" name="id_pedido" placeholder="Insira o ID do Pedido que quer editar" value="<?php echo $idPedido ?>"><br>
            <b> Data </b> <br> 
            <input class="input" type="date" name="data_pedido" placeholder="Altere a Data"
                value="<?php echo $dataPedido ?>"><br>
            <b> Telefone </b> <br> 
