...
<body>
    ...
    <div class="formulario-inserir">
        <form class="formulario" method="POST" action="../../php/Paginas/Plantas/PlantaDelete.php">
            <b> ID </b> <br> 
            <input class="input" type="number" name="id_planta" placeholder="Insira o ID da Planta que quer Deletar" value="<?php echo $idPlanta ?>"><br>
